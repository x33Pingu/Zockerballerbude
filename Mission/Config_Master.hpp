...
class VirtualItems {
	...
	VITEMMACRO(lockpick, "STR_Item_Lockpick", "lockpick", 1, 5000, 75, false, -1, "icons\lockpick.paa")
	...
	//VITEMMACRO(gagkit, "STR_Item_GagKit", "gagkit", 10, 7500, -1, false, -1, "icons\knebel.paa")
...
*/
class Licenses {
	LICENSEMACRO(driver,"STR_License_Driver","driver",3000,false,"civ")
	LICENSEMACRO(boat,"STR_License_Boat","boat",60000,false,"civ")
	LICENSEMACRO(pilot,"STR_License_Pilot","pilot",250000,false,"civ")
	LICENSEMACRO(gun,"STR_License_Firearm","gun",140000,false,"civ")
	LICENSEMACRO(dive,"STR_License_Diving","dive",15000,false,"civ")
	LICENSEMACRO(oil,"STR_License_Oil","oil",30000,false,"civ")
	LICENSEMACRO(cAir,"STR_License_Pilot","cAir",15000,false,"cop")
	LICENSEMACRO(coastguard,"STR_License_CG","cg",10000,false,"cop")
	LICENSEMACRO(heroin,"STR_License_Heroin","heroin",300000,true,"civ")
	LICENSEMACRO(marijuana,"STR_License_Marijuana","marijuana",200000,true,"civ")
	...
	LICENSEMACRO(trucking,"STR_License_Truck","trucking",100000,false,"civ")
	LICENSEMACRO(diamond,"STR_License_Diamond","diamond",120000,false,"civ")
	LICENSEMACRO(salt,"STR_License_Salt","salt",60000,false,"civ")
	LICENSEMACRO(cocaine,"STR_License_Cocaine","cocaine",300000,false,"civ")
	LICENSEMACRO(sand,"STR_License_Sand","sand",80000,false,"civ")
	LICENSEMACRO(iron,"STR_License_Iron","iron",12000,false,"civ")
	...
	LICENSEMACRO(home,"STR_License_Home","home",550000,false,"civ")
	LICENSEMACRO(heavyweapon,"STR_License_Heavyweapon","heavyweapon",1550000,false,"civ")
	LICENSEMACRO(Theorie,"STR_License_Theorie","Theorie",2500,false,"civ")
	LICENSEMACRO(ausweis,"STR_License_Ausweis","ausweis",3500,false,"civ")
	LICENSEMACRO(gsg,"STR_License_GSG","gsg",10000,false,"cop")
};
