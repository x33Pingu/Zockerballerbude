...
class Clothing {
	...
	class cop {
		...
		uniforms[] = {
			...
			{ "U_B_CombatUniform_mcam_vest", "Sergeant/Detective/Lieutenant", 350, { "life_coplevel", "SCALAR", 3 } },
			{ "U_B_CombatUniform_mcam", "Captain/Commander", 1250, { "life_coplevel", "SCALAR", 6 } },
			{ "U_B_CombatUniform_mcam_worn", "SWAT", 550, { "life_coplevel", "SCALAR", 7 } }
		};
