class WeaponShops {
    ...
    class rebel {
        ...
        items[] = {
					{ "hgun_ACPC2_F", "",  95000 },
					{ "9Rnd_45ACP_Mag", "",  6500 },
					{ "hgun_Pistol_heavy_01_F", "",  110000 },
					{ "11Rnd_45ACP_Mag", "",  8500 },
					{ "hgun_Pistol_heavy_02_F", "",  150000 },
					{ "6Rnd_45ACP_Cylinder", "",  8500 },
					{ "SMG_01_F", "",  1350000 },
					{ "30Rnd_45ACP_Mag_SMG_01", "",  1500 },
					{ "SMG_02_F", "",  1350000 },
					{ "30Rnd_9x21_Mag", "",  3800 },
					{ "arifle_Katiba_C_F", "",  1500000 },
					{ "arifle_Katiba_F", "",  1650000 },
					{ "30Rnd_65x39_caseless_green", "",  3800 },
					{ "arifle_MXM_F", "",  1150000 },
					{ "arifle_MXC_F", "",  850000 },
					{ "arifle_MX_F", "",  950000 },
					{ "30Rnd_65x39_caseless_mag", "",  3800 },
					{ "arifle_MX_SW_F", "",  1850000 },
					{ "100Rnd_65x39_caseless_mag", "",  450 },
					{ "arifle_TRG20_F", "",  750000 },
					{ "arifle_TRG21_F", "",  750000 },
					{ "30Rnd_556x45_Stanag", "",  3800 },
					{ "arifle_Mk20_F", "",  650000 },
					{ "arifle_Mk20_plain_F", "",  650000 },
					{ "arifle_Mk20C_F", "",  450000 },
					{ "arifle_Mk20C_plain_F", "",  550000 },
					{ "30Rnd_556x45_Stanag", "",  9500 },
					{ "30Rnd_556x45_Stanag_Tracer_Red", "",  9500 },
					{ "30Rnd_556x45_Stanag_Tracer_Green", "",  9500 },
					{ "30Rnd_556x45_Stanag_Tracer_Yellow", "",  9500 }
        };
    };
        ...
        items[] = {
					...
					{ "MMG_02_black_F", "",  860000 },
					{ "MMG_02_camo_F", "",  860000 },
					{ "MMG_02_sand_F", "",  860000 },
    ...
    class cop_detective {
        name = "Altis Detective Shop";
        side = "cop";
        license = "";
        level = 3;
        msg = "Du bist kein Detective!";
        items[] = {
				{ "NVGoggles", "",  1200 },
				{ "hgun_P07_snds_F" },
				{ "30Rnd_9x21_Mag", "",  300 },
	...
	class cop_master_sergeant {
        name = "Altis Master Sergeant Shop";
        side = "cop";
        license = "";
        level = 5;
        msg = "Du bist kein Master Sergeant!";
        items[] = {
				{ "NVGoggles", "",  1200 },
				{ "hgun_P07_snds_F" },
				{ "30Rnd_9x21_Mag", "",  300 },
	...
	class cop_commander {
        ...
        items[] = {
				...
				{ "arifle_SPAR_01_blk_F", "", 2500 },
				{ "20Rnd_762x51_Mag", "", 300 },
				{ "srifle_GM6_ghex_F", "", 25000 },
	...
	class cop_colonel {
        name = "Altis Colonel Shop";
        side = "cop";
        license = "";
        level = 9;
        msg = "Du bist kein Colonel!";
        items[] = {
				{ "NVGoggles", "",  1200 },
				{ "hgun_P07_snds_F" },
				{ "30Rnd_9x21_Mag", "",  300 },
	...
	class cop_ass_chief {
        ...
        license = "";
        level = 10;
        msg = "Du bist kein Assistant- Chief!";
        items[] = {
				{ "NVGoggles", "",  1200 },
				{ "hgun_P07_snds_F" },
				{ "30Rnd_9x21_Mag", "",  300 },
