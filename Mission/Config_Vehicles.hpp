class CarShops {
	...
	*/
		...
		side = "civ";
		vehicles[] = {
			{ "C_Hatchback_01_F", 10000, "ausweis" }, 
			{ "C_Offroad_01_F", 16000, "ausweis" },
			{ "C_SUV_01_F", 30000, "ausweis" },
			{ "C_Offroad_02_unarmed_F", 40000, "ausweis" },
			{ "C_Hatchback_01_sport_F", 80000, "ausweis" }
		};
	};
	...
	class civ_truck {
		side = "civ";
		vehicles[] = {
			{ "C_Van_01_transport_F", 130000, "trucking" },
			{ "C_Van_01_fuel_F", 160000, "trucking" },
			{ "O_Truck_02_transport_F", 500000, "trucking" },
			{ "O_Truck_02_covered_F", 680000, "trucking" },
			{ "B_Truck_01_transport_F", 1300000, "trucking" },
			{ "B_Truck_01_covered_F", 2200000, "trucking" },	
			{ "B_Truck_01_ammo_F", 1200000, "trucking" },
			{ "O_Truck_03_transport_F", 1200000, "trucking" },
			{ "O_Truck_03_covered_F", 2100000, "trucking" },
			{ "B_Truck_01_box_F", 4500000, "trucking" },
			{ "O_Truck_03_device_F", 10000000, "trucking" },
			{ "O_Truck_02_fuel_F", 2500000, "trucking" },
			{ "B_Truck_01_fuel_F", 800000, "trucking" },
			{ "O_Truck_03_fuel_F", 3200000, "trucking" }
		};
	};
	...
	class reb_car {
		...
		vehicles[] = {
			...
			{ "B_T_LSV_01_unarmed_F", 1150000, "rebel" },
			{ "O_T_LSV_02_unarmed_F", 1150000, "rebel" },
	...
	class cop_car {
		side = "cop";
		vehicles[] = {
			{ "C_Offroad_01_F", 9500, "", { "life_coplevel", -1 } },
			{ "C_SUV_01_F", 10000, "", { "life_coplevel", 2 } },
			{ "C_Hatchback_01_sport_F", 10000, "", { "life_coplevel", 4 } },
	...
	class cop_air {
		side = "cop";
		vehicles[] = {
			{ "B_Heli_Light_01_F", 100000, "cAir", { "life_coplevel", 3 } },
			{ "O_Heli_Light_02_unarmed_F", 120000, "cAir", { "life_coplevel", 6 } },
			{ "I_Heli_light_03_unarmed_F", 140000, "cAir", { "life_coplevel", 7 } },
			{ "B_Heli_Transport_01_F", 160000, "cAir", { "life_coplevel", 9 } }
		};
	};
...
class CfgVehicles {
 ...
 storageFee[] = { 1000, 0, 0, 0 };
	...
	class B_Heli_Light_01_F {
        ...
        textures[] = {
        	{ "Sheriff", "cop", {
                "textures\cop\bullen_hummingbird.paa"
            } },
			{ "Black", "fed", {
