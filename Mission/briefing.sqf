	...
	player createDiaryRecord ["controls",
		[
			"",
				"
				Z: Z Menu Öffnen<br/>
				F1: Headset auf/ab setzen<br/>
				Q: Spitzhacke benutzen<br/>
				U: Auf und Ab Schließen von Autos/Haus<br/>
				F: Polizei Sirene (nur Polizei)<br/>
				T: Fahrzeug Z Menu<br/>
				Left Shift + R: Fesseln (Nur Polizei)<br/>
				Left Shift + G: Niederschlagen (Nur Civ kann dann ausrauben)<br/>
