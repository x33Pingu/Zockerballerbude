class admin_dialog {
	...
	{	
		...
		{
			idc = 2408;
			text = "Kavlla"; //--- ToDo: Localize;
			x = 0.592812 * safezoneW + safezoneX;
			y = 0.302 * safezoneH + safezoneY;
			w = 0.139219 * safezoneW;
			h = 0.022 * safezoneH;
			action = "closeDialog 0; player setPos (getmarkerpos ""civ_spawn_1""); hintc ""Sie sind in Kavalla gespawnt"";";
			tooltip = "Klicken Sie hier, um in Kavalla zu spawnen";
		};
